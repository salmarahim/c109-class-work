...
list_with_first_stdev=[result for result in dice_result if result>first_stdev_start and result<first_stdev_end]
list_with_second_stdev=[result for result in dice_result if result>second_stdev_start and result<second_stdev_end]
list_with_third_stdev=[result for result in dice_result if result>third_stdev_start and result<third_stdev_end]
...
print("{}% of the data lies within the first standard deviation". format(len(list_with_first_stdev)*100/len(dice_result)))

print("{}% of the data lies within the second standard deviation". format(len(list_with_second_stdev)*100/len(dice_result)))

print("{}% of the data lies within the third standard deviation". format(len(list_with_third_stdev)*100/len(dice_result)))